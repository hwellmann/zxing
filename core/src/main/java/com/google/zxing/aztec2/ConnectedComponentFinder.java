 ...
 * component. A path is a sequence of adjacent pixels. A pixel is defined to be adjacent with its
 * four matrix neighbours (north, east, south, west). Alternatively, if the {@code diagonal} flag is
 * set, the diagonal neighbours (north-west, north-east, south-east, south-west) are also defined as
 * adjacent, so that a pixel has up to eight neighbours.
 * <p>
...
public class ConnectedComponentFinder {
     ...
     *            bit matrix
     * @param diagonal
     *            if true, diagonally adjacent pixels are considered as connected
     */
